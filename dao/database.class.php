...
abstract class Database{
	...
	private static $user     = "dsweb"; // crie um novo usuário para sua aplicação
	private static $password = "0Lhza49OXelLqdBa"; // crie uma nova senha para seu usuário
	private static $db       = "teste_dao"; 
